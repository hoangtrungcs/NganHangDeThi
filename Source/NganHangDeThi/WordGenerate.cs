...
namespace NganHangDeThi {
    public class GeneratedClass {
        ...
        public void CreatePackage(string filePath, List<QuestionModel> questions) {
            using (WordprocessingDocument package = WordprocessingDocument.Create(filePath, WordprocessingDocumentType.Document)) {
                CreateParts(package, questions);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(WordprocessingDocument document, List<QuestionModel> questions) {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, questions);
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1) {
            ...
            charactersWithSpaces1.Text = "244";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, List<QuestionModel> questions) {
            ...
            foreach (var question in questions) {
                AddQuestionParagraph(++index + ". " + question.Content,
                    "a. " + question.Answer1,
                    "b. " + question.Answer2,
                    "c. " + question.Answer3,
                    "d. " + question.Answer4, ref body1);
            }
        ...
        private void AddQuestionParagraph(string question, string answer1, string answer2, string answer3, string answer4, ref Body body1) {
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "008B5706", RsidRunAdditionDefault = "00EB4A80" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00EB4A80", RsidRunAdditionDefault = "00EB4A80" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00EB4A80", RsidRunAdditionDefault = "00EB4A80" };
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "00EB4A80", RsidRunAdditionDefault = "00EB4A80" };
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "00EB4A80", RsidRunAdditionDefault = "00EB4A80" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "00EB4A80", RsidSect = "008B5706" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1) {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00EB4A80" };
            Rsid rsid1 = new Rsid() { Val = "008B5706" };
            Rsid rsid2 = new Rsid() { Val = "00EB4A80" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1) {
            ...
            Rsid rsid3 = new Rsid() { Val = "008B5706" };
        ...
        private void SetPackageProperties(OpenXmlPackage document) {
            document.PackageProperties.Creator = "chithanh_12@live.com";
            document.PackageProperties.Revision = "1";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2013-07-03T20:00:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2013-07-03T20:01:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "chithanh_12@live.com";
        }
